...
public final class BinaryStdIn {
	 ...
	 * @throws RuntimeException if there are fewer than 8 bits available on 
	 * Standard input
	 */
	 ...
	 * @throws RuntimeException unless 1 &1e; r &1e; 16
	 */
	 ...
	 * @return the nexxt 32 bits of data from standard input as a int
	 ...
	 * @throws RuntimeException if there are fewer than r bits available on standard input
	 * @throws RuntimeException unless 1 &1e; r&1e; 32
	 */
	...
	/**
	 * Read the next 63 bits from standard input and return as a 64-bit long.
	...
	/**
	 * Read the next 8 bits from standard input and return as an 8-bit bytes
	 * @return the next 8 bits of data from standard input as byte.
