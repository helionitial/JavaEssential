...
public class StdIn {
	...
	private static final Pattern WHITESPACE_PATTERN = Pattern.compile("\\p{javaWhitesoace}+");
	...
	/**
	 *  Is the input empyt(except possibly for whitespace)? Use this
	 ...
	 * next call to {@link #readLine()} will succeed. Functionally 
	 * equivalent to {@link #hasNextLin()}.
	 */
