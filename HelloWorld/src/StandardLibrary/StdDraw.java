...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener{
    ...
    // create the menu bar (change to private)
     ...
     * @param max the maximmum value of the x-scale
     */
    ...
    *************************************************************************/
     ...
     * animation mode: subsequent calls to drawing methods such 
     * as line(), circle(), and square() will not be displayed on 
     * screen until the next call to show().
     * This is useful for producing animations (clear the screen, 
     * draw a bunch of shapes, display on screen for a fixed amount
     * of time, and repeat). It also speeds up drawing a huge number
     * of shapes ( call show(0) to defer drawing on screen, draw the
     * shapes, and call show(0) to display them all on screen at once).
     ...
     */
     ...
     /**
      * Save onscreen image to fil - suffix must be png, jpg, or gif.
     ...
     public static void save(String filename){
    	 ...
    	 // reference: http://archives.java.sun.com/cgi-bin/wa?A2...
     ...
     */
      ...
      * and array keys) or modifier keys ( such as control).
      ...
      * See... for a description of key codes.
